...
[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/geo_calculator)](https://pypi.org/project/geo-calculator/)
---
...
-   [Sample release project @ GitHub](https://github.com/pypa/sampleproject) 
-   [Setup.Py example](https://github.com/pypa/sampleproject/blob/master/setup.py)
